...
const CarSection = () => {
  return (
    <DashSections
      ...
      img={inifinity}
      paragraph="Find certified foreign used cars available for sale at Betacar. Trusted used cars dealer at affordable prices. Get car financing, or book test drive."
    />
  );
};
